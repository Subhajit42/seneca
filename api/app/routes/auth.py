...
from app.utils.responses import APIBaseException, NotFoundException, ConflictException, UnauthorizedException
...
def user_register():
    ...
    exception = validate_none(APIBaseException, username=username, email=email, password=password)
